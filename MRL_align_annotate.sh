...
FASTQ='/local/projects-t2/HRBV/MRL/MRL_'$SAMPLE'/'$SAMPLE
OUT='/local/projects-t2/HRBV/MRL/alignment/MRL_'$SAMPLE"_aln_hg19"
...
/local/projects-t2/HRBV/MRL/MRL_format_alignment_stats.py $OUT"/align_summary.txt" $OUT"/align_summary_formatted.txt"
...
/usr/local/bin/samtools idxstats $SORTED_BAM_PREFIX".bam" > $WD"/"$SAMPLE".alignmentStats.txt"
